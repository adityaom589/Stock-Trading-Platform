        ...
        <div className='container border-top'>
            <div className='row'>
                ...
                <div className='col'>
                    ...
                    <a className='text-muted' href='' style={{ textDecoration: "none" }}>Open demat account</a>
                    <br />
                ...
                <div className='col'>
                    ...
                    <a href=''  className='text-muted'  style={{ textDecoration: "none" }}>Upcoming IPOs</a>
                    <br />
                    <a href=''  className='text-muted'  style={{ textDecoration: "none" }}>Brokerage charges</a>
                    <br />
                    <a href=''  className='text-muted'  style={{ textDecoration: "none" }}>Market holidays</a>
                    <br />
                    <a href=''  className='text-muted'  style={{ textDecoration: "none" }}>Economic calendar</a>
                    <br />
                    <a href='' className='text-muted'  style={{ textDecoration: "none" }} >Calculators</a>
                    <br />
                    <a href=''  className='text-muted'  style={{ textDecoration: "none" }}>Markets</a>
                    <br />
                    <a href='' className='text-muted'  style={{ textDecoration: "none" }} >Sectors</a>
                    <br />
            ...
            <div className='col px-3 text-center mb-3'>
            <a href='' className='text-muted px-2'  style={{ textDecoration: "none", fontSize:"10px" }} >NSE</a>
            <a href='' className='text-muted px-2'  style={{ textDecoration: "none", fontSize:"10px" }} >BSE​</a>
            <a href='' className='text-muted px-2'  style={{ textDecoration: "none", fontSize:"10px" }} >Terms & conditions</a>
            <a href='' className='text-muted px-2'  style={{ textDecoration: "none", fontSize:"10px" }} >Policies & procedures </a>
            <a href='' className='text-muted px-2'  style={{ textDecoration: "none", fontSize:"10px" }} >Privacy policy </a>
            <a href='' className='text-muted px-2'  style={{ textDecoration: "none", fontSize:"10px" }} >Disclosure</a>
            <a href='' className='text-muted px-2'  style={{ textDecoration: "none", fontSize:"10px" }} >For investor's attention </a>
            <a href='' className='text-muted px-2'  style={{ textDecoration: "none", fontSize:"10px" }} >Investor charter</a>
