        ...
        <div className='row p-2'>
            ...
            <div className='col-6 p-5'>
                ...
                <div className='text-center'>
                    ...
                    <a href='' style={{ textDecoration: "none" }} className='mx-5'>Try Kite Demo <i class="fa-solid fa-arrow-right-long"></i></a>
                </div>
               
            </div>
        </div>
         <div className='text-center mt-3 mb-4'>
            <img src='media\images\pressLogos.png' style={{width:"50%" }} alt='press'  />
         </div>
       </div>
     );
}
